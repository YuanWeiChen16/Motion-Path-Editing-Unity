...
public class BVHReader : MonoBehaviour
{
    ...
    [Header("========= Unity Chan 的設定 ==========")]
     List<float>          OffSetHeight = new List<float>();


    private GameObject PeopleGroup;
     List<GameObject>     People = new List<GameObject>();                    // 所有人的 GameObject
     string[]             FilePaths;                                          // 存所有 File 的 Path
